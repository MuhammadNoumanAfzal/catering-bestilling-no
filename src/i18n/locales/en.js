const en = {
  ...
  browse: {
    ...
    filterOptions: {
      ...
      offer: {
        ...
        fee0To150: "Delivery Fee: 0–150 NOK",
        fee150To300: "Delivery Fee: 150–300 NOK",
        fee300Plus: "Delivery Fee: 300+ NOK",
      ...
      pricing: {
        ...
        range2000To5000: "2,000–5,000 NOK",
        over5000: "Over 5,000 NOK",
  ...
  auth: {
    ...
    signIn: {
      ...
      invalidCredentials: "The email or password does not look right. Please check them and try again, or choose Forgot password.",
    },
    signUp: {
      ...
      phoneHelper: "Norway only. Enter the eight digits after +47.",
      invalidPhone: "Enter a valid Norwegian phone number with eight digits after +47.",
      postCode: "Post code",
  ...
  vendor: {
    ...
    addOns: "Add-ons",
    tip: "Tip",
    customTipAmount: "Enter custom tip amount",
    ...
    reviews: {
      ...
      noReviewsDescription: "Reviews can be submitted after an eligible order is completed.",
      generalOccasion: "General",
  ...
  orderValidation: {
    ...
    futureDeliveryDate: "Please select today or a future delivery date.",
    selectDeliveryTime: "Please select a delivery time.",
    futureDeliveryTimeToday: "Please select a future delivery time for today.",
    minimumPersonCount: "Person count must be at least {{count}}.",
    deliveryPostalCode: "Please enter the delivery postal code.",
    vendorPostalCodeUnavailable: "The vendor \"{{vendorName}}\" does not deliver to postal code {{postalCode}}.",
    deliveryCity: "Please enter the delivery city.",
    invoiceAddress: "Please enter the invoice address.",
    invoicePostalCode: "Please enter the invoice postal code.",
    invoiceCity: "Please enter the invoice city.",
    phone: "Please enter the phone number.",
    validEmail: "Please enter a valid email address.",
    companyName: "Please enter the company name.",
    organizationNumber: "Please enter the organization number.",
    eventName: "Please enter the event name.",
    firstName: "Please enter the first name.",
    lastName: "Please enter the last name.",
    occasion: "Please enter the occasion.",
  },
  alerts: {
    okay: "Okay",
    continue: "Continue",
  ...
  checkout: {
    ...
    subtotalVatIncluded: "Subtotal (VAT included)",
    subtotal: "Subtotal",
    deliveryFee: "Delivery fee",
    addOns: "Add-ons",
    vat: "VAT",
  ...
  modifyOrder: {
    ...
    checkingAvailability: "Checking vendor availability...",
    availableTitle: "Available for delivery",
    unavailableTitle: "Unavailable for delivery",
    availabilityNeedsInputTitle: "Check availability",
    availabilityNeedsInputMessage:
      "Select the date, time, and postal code to check whether this vendor can deliver.",
    availableWindows: "Available delivery windows: {{windows}}",
    selectedDate: "Selected date: {{date}}",
    additionalDetails: "Additional Details",
    sending: "Sending...",
    sendRequest: "Send Request",
    vendorAvailable: "{{vendor}} is available for the selected date, time, and postal code.",
    thisVendor: "This vendor",
    noLongerModifiable:
    ...
    errors: {
      ...
      time24h: "Please select a valid time in 24-hour format (HH:MM).",
      futureTimeToday: "Please select a future time for today.",
      ...
      postalCodeFormat: "Please enter a valid 4 or 5 digit postal code.",
      personCount: "Person count must be at least 1.",
      vendorPostalUnavailable: "{{vendor}} does not deliver to postal code {{postalCode}}.",
      vendorClosedOnDate: "{{vendor}} is not available on the selected date.",
      vendorUnavailableOnDate: "{{vendor}} has no delivery availability on the selected date.",
      vendorUnavailableAtTime: "{{vendor}} is not available at {{time}} on the selected date.",
    },
  },
  vendorPanel: {
    ...
    searching: "Searching vendors and menus...",
    clientDashboard: "Client dashboard",
    ...
    addressPage: {
      ...
      statePlaceholder: "Enter county or state",
      postalCodePlaceholder: "Enter postal code",
      phonePlaceholder: "Enter phone number",
      receivingPlaceholder: "Enter delivery contact",
      instructionsPlaceholder: "Enter delivery instructions",
    ...
    settingsPage: {
      title: "Settings",
      onboardingBadge: "Complete account setup",
      onboardingTitle: "Complete your account setup",
      onboardingDescription: "Complete your account information on this Settings page, including your profile photo. Then go to the Addresses page to add your delivery and invoice address details.",
      onboardingPhotoStep: "Add profile photo",
      onboardingAddressStep: "Fill address information",
      onboardingAddressAction: "Go to Addresses",
      onboardingLaterAction: "I will do this later",
      profile: "Profile",
      firstName: "First name *",
      lastName: "Last name *",
  ...
  browse: {
    ...
    deliveryFee: "Delivery fee",
    menusAvailable: "{{count}} menus available",
    noActiveMenus: "No active menus currently",
