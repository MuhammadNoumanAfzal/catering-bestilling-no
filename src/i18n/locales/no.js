const no = {
  ...
  browse: {
    ...
    filterOptions: {
      ...
      offer: {
        ...
        fee300Plus: "Leveringsgebyr: 300+ kr",
        acceptsDiscountCode: "Godtar rabattkode",
        haveDiscount: "Har rabatt",
      },
      pricing: {
        anyPrice: "Valgfri pris",
        under500: "Under 500 kr",
        range500To1000: "500–1 000 kr",
        range1000To2000: "1 000–2 000 kr",
        range2000To5000: "2 000–5 000 kr",
        over5000: "Over 5 000 kr",
  ...
  vendor: {
    ...
    addOns: "Tillegg",
    tip: "Tips",
    customTipAmount: "Skriv inn egendefinert tipsbeløp",
  ...
  orderValidation: {
    ...
    invoiceCity: "Skriv inn fakturaby.",
    phone: "Skriv inn telefonnummer.",
    validEmail: "Skriv inn en gyldig e-postadresse.",
    companyName: "Skriv inn firmanavn.",
    organizationNumber: "Skriv inn organisasjonsnummer.",
    eventName: "Skriv inn arrangementsnavn.",
    firstName: "Skriv inn fornavn.",
    lastName: "Skriv inn etternavn.",
    occasion: "Skriv inn anledning.",
  },
  alerts: {
    okay: "OK",
    continue: "Fortsett",
  ...
  checkout: {
    ...
    subtotalVatIncluded: "Delsum (MVA inkludert)",
    subtotal: "Delsum",
    deliveryFee: "Leveringsgebyr",
    addOns: "Tillegg",
    vat: "MVA",
  ...
  browse: {
    ...
    deliveryFee: "leveringsgebyr",
    menusAvailable: "{{count}} menyer tilgjengelig",
    noActiveMenus: "Ingen aktive menyer akkurat nå",
