...
export default function AuthLayout() {
  ...
  return (
    <main
      className={`${isSignUpPage ? "min-h-[100dvh] overflow-y-auto" : "h-[100dvh] overflow-hidden"} bg-[linear-gradient(180deg,#fff8f2_0%,#f8f0e9_54%,#f4ece4_100%)] px-4 py-3 sm:px-6 sm:py-4 lg:px-8`}
    >
      <div className={`relative mx-auto max-w-7xl ${isSignUpPage ? "min-h-full" : "h-full"}`}>
        ...
        <div
          className={`grid rounded-[34px] border border-[#eadccf] bg-[rgba(255,251,247,0.82)] shadow-[0_30px_90px_rgba(69,42,19,0.12)] backdrop-blur xl:grid-cols-[0.88fr_1.12fr] ${isSignUpPage ? "min-h-full" : "h-full overflow-hidden"}`}
        >
          <section className="relative hidden overflow-hidden border-r border-[#eadfd5] bg-[radial-gradient(circle_at_top_left,rgba(207,110,56,0.22),transparent_34%),radial-gradient(circle_at_bottom_left,rgba(246,219,191,0.45),transparent_38%),linear-gradient(160deg,#2f241d_0%,#493326_42%,#c76838_140%)] p-8 text-white xl:flex xl:flex-col xl:justify-center">
          ...
          <section className="flex min-h-0 items-center justify-center px-4 py-4 sm:px-8 sm:py-5 lg:px-10 xl:px-12">
            <div className={`${isSignUpPage ? "" : "max-h-full "}w-full max-w-[500px]`}>
              <Outlet />
            </div>
          </section>
        </div>
